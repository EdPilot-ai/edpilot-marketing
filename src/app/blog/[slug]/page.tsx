  ...
  return (
    <nav aria-label="Table of contents" className="hidden xl:block">
      <div className="sticky top-36 w-52">
        <div className="section-kicker mb-4 flex items-center gap-1.5 text-text-secondary">
          ...
          {entries.map((entry) => (
            <li key={entry.id}>
              ...
              >
                {activeId === entry.id && (
                  <ChevronRight
                    className="w-3 h-3 flex-shrink-0 mt-0.5 text-accent"
                    aria-hidden="true"
                  />
                )}
          ...
          <Container size="narrow">
                    ...
                    <article className="flex items-start gap-4 p-5 rounded-lg border border-border-gray bg-bg-page hover:border-accent/25 transition-all duration-200">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1.5">
                          <span className="section-kicker text-accent">{related.category}</span>
                          <span className="text-border-gray text-xs" aria-hidden="true">
                            ·
                          </span>
            ...
            <div className="mt-8">
              <Button
                asChild
                variant="outline"
                className="border-border-gray hover:border-text-secondary"
              >
                <Link href="/blog">
                  View All Articles
