...
// Browser tab favicon, generated as a PNG so it renders identically across
// every browser/OS. The previous SVG-only favicon (public/favicon.svg) did
// not render in Safari on macOS, which is why the icon showed on Windows but
// not on Mac. The artwork below is byte-for-byte identical to that SVG, and
// kept in sync with the app at edpilot-app/src/app/icon.tsx so edpilot.ai and
// app.edpilot.ai show the same tab icon.
