        ...
        scenarios={[
          {
            ...
            oldWay:
              "Now it needs permissions, citations, logging, audits, support, onboarding, and a roadmap.",
        ...
        sections={[
          {
            ...
            body: "Custom AI requires engineering, model operations, security review, infrastructure, UX, faculty workflows, and ongoing support. EdPilot lets institutions deploy AI-assisted teaching without becoming an AI infrastructure company.",
          },
          {
            title: "Hidden implementation risk",
            body: "Most internal AI builds start as prototypes and become products only after months of hard platform work. The risky parts are not the demo; they are governance, scale, permissions, audits, and support.",
          },
          {
            title: "The real decision",
            body: "This is less build versus buy than infrastructure versus educational outcome. If the goal is better teaching support, EdPilot gets you there faster.",
          },
        ]}
      />
    </>
