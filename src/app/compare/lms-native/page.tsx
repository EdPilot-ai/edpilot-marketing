        ...
        sections={[
          {
            ...
            body: "If an LMS vendor does not prioritize a governance feature, your institution waits. EdPilot is built specifically around the AI governance and course-grounding problem.",
          },
          {
            title: "Institutional continuity",
            body: "Universities change LMSs, consolidate systems, and run multiple platforms. EdPilot keeps AI policy and course intelligence independent from any single LMS vendor.",
          },
          {
            title: "Integration quality",
            body: "EdPilot can integrate with LMS workflows while remaining the source of truth for AI behavior, visibility, and faculty control.",
          },
        ]}
      />
    </>
