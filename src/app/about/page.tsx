        ...
        <Container>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <FeatureCard
              icon={BookOpen}
              title="Course-bound"
              description="Each course gets its own AI, trained on its own materials. Nothing bleeds across courses or departments."
            />
            <FeatureCard
              icon={GraduationCap}
              title="Faculty-governed"
              description="Scope, tone, and guardrails are set by the instructor, not by a vendor default."
            />
            <FeatureCard
              icon={Building2}
              title="Institutionally designed"
              description="Built for IT, legal, and compliance teams to approve, not for shadow adoption."
            />
          </div>
        </Container>
      </Section>
